...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x1, 0); // write to D/C
    GPIOPinWrite(GPIOA3_BASE, 0x40,0); // OC low

    //
    // Push the character over SPI
    //
    MAP_SPITransfer(GSPI_BASE,&c,0,1,
    ...
    GPIOPinWrite(GPIOA3_BASE, 0x40,0x40); // OC high
...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x1,0x1); // write to D/C high
    GPIOPinWrite(GPIOA3_BASE, 0x40,0); // OC low
    //
    // Push the character over SPI
    //
